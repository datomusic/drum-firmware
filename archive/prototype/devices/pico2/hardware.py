...
class ToggleButton:
    def __init__(self, pin, inverted=True):
        ...
        self.digital = digitalio.DigitalInOut(self.pin)
...
class AnalogReader:
    def __init__(self, pin, mapping=LinearMapping) -> None:
        self.pin = pin
        self.analog = analogio.AnalogIn(self.pin)
        self.mapping = mapping

    def read(self) -> int:
        return self.mapping(self.analog.value)

class MuxAnalogReader:
    def __init__(self, address_pins, adc_pin, mapping=LinearMapping) -> None:
        self.adc_pin = adc_pin
        self.analog = analogio.AnalogIn(self.adc_pin)
...
class DigitalReader:
    def __init__(self, pin):
        self.pin = pin
        self.input = digitalio.DigitalInOut(self.pin)
