...
PizzaControls::PizzaControls(PizzaDisplay &display_ref)
    : display(display_ref), keypad(keypad_decoder_pins, keypad_columns_pins, 10, 5, 1000),
      ...
      mux_controls{                       // Initialize by explicitly calling constructors
                   ...
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, DRUM1},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, FILTER},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, DRUM2},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, PITCH1},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, PITCH2},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, PLAYBUTTON},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, RANDOM},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, VOLUME},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, PITCH3},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, SWING},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, CRUSH},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, DRUM3},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, REPEAT},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, DRUM4},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, SPEED},
                   Musin::UI::AnalogControl{PIN_ADC, analog_address_pins, PITCH4}},
      control_observers{
