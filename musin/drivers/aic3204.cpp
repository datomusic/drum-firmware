...
Aic3204::Aic3204(uint8_t sda_pin, uint8_t scl_pin, uint32_t baudrate)
  ...
  if (write_register(0x00, 0x37, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x04, 0x07) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x05, 0x93) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x06, 0x14) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x07, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x08, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x0B, 0x85) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x0C, 0x83) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x0D, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x0E, 0x80) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x1B, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x19, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x3C, 0x08) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x01, 0x08) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x02, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x02, 0x01) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x0A, 0x33) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x03, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x04, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x47, 0x32) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x7B, 0x01) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x14, 0x05) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x0C, 0x08) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x0D, 0x08) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x10, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x11, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x0E, 0x01) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x0F, 0x08) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x12, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x13, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x01, 0x09, 0x3C) != Aic3204Status::OK) return;
  ...
  if (write_register(0x00, 0x00, 0x00) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x3F, 0xD6) != Aic3204Status::OK) return;
  if (write_register(0x00, 0x40, 0x00) != Aic3204Status::OK) return;
