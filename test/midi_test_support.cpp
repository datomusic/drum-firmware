...
MockMidiCallRecord MockMidiCallRecord::PolyAftertouch(uint8_t ch, uint8_t note,
                                                      uint8_t pressure) {
  return {"_sendPolyAftertouch_actual", ch, note, pressure, 0,
          ::midi::InvalidType,          {}, 0};
}
...
void _sendPolyAftertouch_actual(uint8_t channel, uint8_t note,
                                uint8_t pressure) {
  mock_midi_calls.push_back(
      MockMidiCallRecord::PolyAftertouch(channel, note, pressure));
}
